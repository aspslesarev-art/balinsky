#!/usr/bin/env node
// Aggregate knowledge layer for Балина: per-district investor guides + a
...
const DISTRICT_SYSTEM = `Ты — Балина, эксперт по рынку недвижимости Бали для русскоязычных инвесторов.
