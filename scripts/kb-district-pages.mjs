...
const SYS = `Ты — Балина, эксперт по недвижимости Бали. По сводке и цифрам района напиши редакционный блок для SEO-страницы каталога. Опирайся ТОЛЬКО на данные — ничего не выдумывай (доходность не называй, если её нет). Верни СТРОГО JSON без markdown:
