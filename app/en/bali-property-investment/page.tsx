...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/en/bali-property-investment',
    languages: {
  ...
  openGraph: {
    ...
    type: 'article',
    url: '/en/bali-property-investment',
        ...
        <article className="mt-6 mb-16 max-w-4xl">
                  ...
                  {REGIONS.map(r => (
                    <tr key={r.slug} className="border-b border-[var(--color-border)]">
                      ...
                      <td className="py-3 px-3 text-right">
                        <Link href={`/en/villas`} className="text-[var(--color-primary)] text-[13px] inline-flex items-center gap-1 no-underline hover:underline">
          ...
          <section className="mb-12">
            ...
            <p className="mt-4 text-[14px] text-[var(--color-text-muted)]">
              Full transaction guide on the <Link href="/en/how-to-buy" className="text-[var(--color-primary)] no-underline hover:underline">«How to buy property in Bali»</Link> page.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="mt-6 text-[14px]">
              More on <Link href="/en/about" className="text-[var(--color-primary)] no-underline hover:underline">«About Balinsky»</Link>.
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <Link href="/en/villas" className="block rounded-2xl border border-[var(--color-border)] p-5 bg-white no-underline hover:border-[var(--color-primary)] transition-colors">
              ...
              <Link href="/en/apartments" className="block rounded-2xl border border-[var(--color-border)] p-5 bg-white no-underline hover:border-[var(--color-primary)] transition-colors">
              ...
              <Link href="/en/complexes" className="block rounded-2xl border border-[var(--color-border)] p-5 bg-white no-underline hover:border-[var(--color-primary)] transition-colors">
              ...
              <Link href="/en/how-to-buy" className="block rounded-2xl border border-[var(--color-border)] p-5 bg-white no-underline hover:border-[var(--color-primary)] transition-colors">
