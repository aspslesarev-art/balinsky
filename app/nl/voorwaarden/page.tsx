...
export default function Page() {
  return (
    <LegalLayout lang="nl" title="Terms of Use" updated={`Last updated: ${UPDATED}`} breadcrumbLabel="Terms of Use">
      <p>
      ...
      <p>
        ...
        right to share them. How that data is used: see our <a href="/nl/privacy">Privacy Policy</a>.
      </p>
      <p>
