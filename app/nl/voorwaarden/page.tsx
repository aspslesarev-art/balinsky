...
export default function Page() {
  return (
    <LegalLayout lang="nl" title="Gebruiksvoorwaarden" updated={`Laatst bijgewerkt: ${UPDATED}`} breadcrumbLabel="Gebruiksvoorwaarden">
      ...
      <h2>2. Wie de site exploiteert</h2>
      <p>
        De site wordt geëxploiteerd door Andrei Slesarau, eenmanszaak geregistreerd in Georgië: registratienummer
        316362404 van 06.01.2022, adres 19 Shartava St., Rustavi, Georgië. Alle contracten en facturen worden door
        die entiteit uitgegeven, naar Georgisch recht.
      </p>
      <p>
        De enige inkomstenbron van het platform is de vergoeding die ontwikkelaars en andere rechthebbenden betalen
        voor het publiceren van informatie en advertenties: banners en vermeldingen op de site, publicaties in het
        Telegram-kanaal en videoproductie over projecten. Die vergoeding hangt niet af van de vraag of een lezer
        daadwerkelijk koopt. Bezoekers betalen niets: geen abonnement, geen commissie, geen bemiddelingsloon.
      </p>
      <p>
        De exploitant van de site verleent geen diensten op Indonesisch grondgebied. Het publiceren van de catalogus,
        het redactionele werk en het beheer gebeuren door een in Georgië geregistreerde entiteit.
      </p>

      <h2>3. Wat Balinsky.info niet is</h2>
      <p>
      ...
      <h2>11. Toepasselijk recht en jurisdictie</h2>
      <p>
