...
export default function Page() {
  return (
    <LegalLayout lang="nl" title="Contact" updated={`Information current as of: ${UPDATED}`} breadcrumbLabel="Contact">
      <p>
      ...
      <ul>
        <li><Link href="/nl/privacy">Privacy Policy</Link></li>
        <li><Link href="/nl/voorwaarden">Terms of Use</Link></li>
        <li><Link href="/nl/over-ons">About Balinsky</Link></li>
      </ul>
    </LegalLayout>
  )
}
