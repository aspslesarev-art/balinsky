...
export default function Page() {
  return (
    <LegalLayout lang="uk" title="Contact" updated={`Information current as of: ${UPDATED}`} breadcrumbLabel="Contact">
      <p>
      ...
      <ul>
        <li><Link href="/uk/konfidentsiynist">Privacy Policy</Link></li>
        <li><Link href="/uk/umovy">Terms of Use</Link></li>
        <li><Link href="/uk/pro-nas">About Balinsky</Link></li>
      </ul>
    </LegalLayout>
  )
}
