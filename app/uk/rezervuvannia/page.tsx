...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/uk/rezervuvannia',
    languages: { ru: `${SITE_URL}/ru/rezervirovanie`, en: `${SITE_URL}/uk/rezervuvannia` , 'x-default': `${SITE_URL}/ru/rezervirovanie`},
  },
  openGraph: {
