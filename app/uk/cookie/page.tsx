...
export default function Page() {
  return (
    <LegalLayout lang="uk" title="Cookie Policy" updated={`Last updated: ${UPDATED}`} breadcrumbLabel="Cookie Policy">
      <p>
      ...
      <ul>
        <li><a href="/uk/konfidentsiynist">Privacy Policy</a></li>
        <li><a href="/uk/umovy">Terms of Use</a></li>
      </ul>
