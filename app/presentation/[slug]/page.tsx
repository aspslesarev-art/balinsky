                          ...
                          {units.map(u => (
                            <li key={u.id}>
                              <LinkMenu
                                ...
                                className="block w-full text-left bg-[#FAFAF8] hover:bg-white border border-[#E5E7EB] hover:border-[#1F8B5F] hover:shadow-md transition-shadow rounded-2xl overflow-hidden text-[#111827]"
                              >
                                {u.photo ? (
                                  // eslint-disable-next-line @next/next/no-img-element
                                ...
                                <div className="p-4">
                                  <div className="text-[13px] text-[#6B7280] mb-1.5 flex items-center gap-1 flex-wrap">
