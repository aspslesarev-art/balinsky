...
export default function Page() {
  return (
    <LegalLayout lang="zh" title="Cookie Policy" updated={`Last updated: ${UPDATED}`} breadcrumbLabel="Cookie Policy">
      <p>
      ...
      <ul>
        <li><a href="/zh/yinsi">Privacy Policy</a></li>
        <li><a href="/zh/tiaokuan">Terms of Use</a></li>
      </ul>
