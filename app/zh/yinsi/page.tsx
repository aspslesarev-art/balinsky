...
export default function Page() {
  return (
    <LegalLayout lang="zh" title="隐私政策" updated={`最后更新：${UPDATED}`} breadcrumbLabel="隐私政策">
      ...
      <h2>1. 网站运营方</h2>
      <p>
        Balinsky.info 是一个私人运营的信息项目。数据保护相关咨询请联系：<a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a>，
      ...
      <ul>
        ...
        <li><strong>OpenAI / Azure OpenAI</strong> — 为 Andrei AI 助手提供支持。若您向助手发送消息，您的消息及相关上下文会被发送至该服务商的 API。</li>
      </ul>
