...
export default function Page() {
  return (
    <LegalLayout lang="zh" title="Privacy Policy" updated={`Last updated: ${UPDATED}`} breadcrumbLabel="Privacy Policy">
      <p>
        This policy explains what personal data the site <a href="/zh">Balinsky.info</a> collects, why,
      ...
      <ul>
        ...
        <li>Cookies — see the <a href="/zh/cookie">Cookie Policy</a> for details.</li>
      </ul>
