...
export async function generateMetadata() {
  const cat = generateCategoryMeta({ category: 'developers', locale: 'zh', ...(await publishedDeveloperCount()) })
...
export default async function Page({ searchParams }: { searchParams: SP }) {
  ...
  return <DevelopersCatalog sort={parseSort(sp.sort)} lang="zh" />
}
