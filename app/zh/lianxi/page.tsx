...
export default function Page() {
  return (
    <LegalLayout lang="zh" title="Contact" updated={`Information current as of: ${UPDATED}`} breadcrumbLabel="Contact">
      <p>
      ...
      <ul>
        <li><Link href="/zh/yinsi">Privacy Policy</Link></li>
        <li><Link href="/zh/tiaokuan">Terms of Use</Link></li>
        <li><Link href="/zh/guanyu">About Balinsky</Link></li>
      </ul>
    </LegalLayout>
  )
}
