...
export default async function Page({ params, searchParams }: { params: Params; searchParams: SP }) {
  ...
  if (page === 1) {
    ...
    permanentRedirect(qs ? `/ru/zhilye-kompleksy?${qs}` : '/ru/zhilye-kompleksy')
  }
  ...
  return <ComplexesCatalog filters={filters} page={page} basePath="/ru/zhilye-kompleksy" />
}
