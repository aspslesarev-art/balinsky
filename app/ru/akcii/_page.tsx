...
const COPY = {
  ...
  de: {
    title: 'Aktionen und Sonderangebote von Bali-Bauträgern | Balinsky',
    description: 'Rabatte, Ratenzahlungen und Sonderangebote von Bauträgern für Villen und Apartments auf Bali.',
    h1: 'Aktionen',
    sub: 'Rabatte, Ratenzahlungen und Sonderangebote von Bali-Bauträgern',
    active: 'Aktiv',
    expiredHeading: 'Abgelaufen',
    expired: 'abgelaufen',
    top: 'Top',
    until: (d: string) => `Bis ${d}`,
    empty: 'Noch keine aktiven Aktionen.',
    locale: 'de-DE',
  },
  zh: {
    title: '巴厘岛开发商的促销和特别优惠 | Balinsky',
    description: '开发商为巴厘岛别墅和公寓提供的折扣、分期付款和特别优惠。',
    h1: '促销',
    sub: '巴厘岛开发商的折扣、分期付款和特别优惠',
    active: '进行中',
    expiredHeading: '已结束',
    expired: '已结束',
    top: '置顶',
  ...
  nl: {
    title: 'Acties en speciale aanbiedingen van Bali-ontwikkelaars | Balinsky',
    description: 'Kortingen, termijnbetalingen en speciale aanbiedingen van ontwikkelaars voor villa\'s en appartementen op Bali.',
    h1: 'Acties',
    sub: 'Kortingen, termijnbetalingen en speciale aanbiedingen van Bali-ontwikkelaars',
    active: 'Actief',
    expiredHeading: 'Verlopen',
    expired: 'verlopen',
    top: 'top',
    until: (d: string) => `Tot ${d}`,
    empty: 'Nog geen actieve acties.',
    locale: 'nl-NL',
  },
  ban: {
    title: 'Promosi lan penawaran khusus saking pangwangun Bali | Balinsky',
    description: 'Diskon, cicilan, lan penawaran khusus saking pangwangun kanggo vila lan apartemen ring Bali.',
    h1: 'Promosi',
    sub: 'Diskon, cicilan, lan penawaran khusus saking pangwangun Bali',
    active: 'Aktif',
    expiredHeading: 'Puput',
    expired: 'puput',
    top: 'top',
    until: (d: string) => `Nganti ${d}`,
