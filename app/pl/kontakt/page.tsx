...
export default function Page() {
  return (
    <LegalLayout lang="pl" title="Contact" updated={`Information current as of: ${UPDATED}`} breadcrumbLabel="Contact">
      <p>
      ...
      <ul>
        <li><Link href="/pl/prywatnosc">Privacy Policy</Link></li>
        <li><Link href="/pl/regulamin">Terms of Use</Link></li>
        <li><Link href="/pl/o-nas">About Balinsky</Link></li>
      </ul>
    </LegalLayout>
  )
}
