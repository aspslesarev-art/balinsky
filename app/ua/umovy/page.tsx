...
export default function Page() {
  return (
    <LegalLayout lang="uk" title="Умови використання" updated={`Останнє оновлення: ${UPDATED}`} breadcrumbLabel="Умови використання">
      ...
      <h2>2. Хто є оператором сайту</h2>
      <p>
        Сайт веде фізична особа-підприємець Andrei Slesarau, зареєстрований у Грузії: реєстраційний номер 316362404
        від 06.01.2022, юридична адреса 19 Shartava St., Rustavi, Georgia. Усі договори й рахунки виставляються від
        цієї особи та за законодавством Грузії.
      </p>
      <p>
        Єдине джерело доходу майданчика — плата забудовників та інших правовласників обʼєктів за розміщення
        інформації й реклами: банери та картки на сайті, публікації в Telegram-каналі, виробництво відеоматеріалів
        про проєкти. Ця плата не залежить від того, чи відбудеться в читача угода. З відвідувачів сайту ми не беремо
        нічого — ні підписки, ні комісії, ні винагороди за підбір.
      </p>
      <p>
        Оператор сайту не надає послуг на території Індонезії. Публікація каталогу, редакційна робота та
        адміністрування ведуться від особи, зареєстрованої в Грузії.
      </p>

      <h2>3. Чим Balinsky.info не є</h2>
      <p>
        Ми не агентство нерухомості, не брокер і не ріелтор. Зокрема, ми не продаємо обʼєкти й не виступаємо
        продавцем; не представляємо інтереси покупця чи продавця в переговорах; не готуємо, не підписуємо й не
        посвідчуємо договори; не приймаємо й не зберігаємо завдатки, депозити та будь-які платежі за угодами; не
        беремо комісію з покупців; не організовуємо покази, поїздки й огляди обʼєктів; не надаємо юридичних,
        нотаріальних, податкових і візових послуг.
      </p>
      <p>
        Усе перелічене роблять самі сторони угоди та залучені ними ліцензовані фахівці — забудовник або власник,
        нотаріус PPAT, юрист, податковий консультант. Контакти оператора обʼєкта вказані в картці цього обʼєкта;
        листування й переговори йдуть напряму з ним, поза Balinsky.
      </p>

      <h2>4. Достовірність</h2>
      <p>
      ...
      <p>
        ...
        право ними ділитися. Як використовуються ці дані: дивіться нашу <a href="/ua/konfidentsiynist">Політику конфіденційності</a>.
      </p>
      <p>
      ...
      <h2>7. AI-асистент Andrei</h2>
      <p>
        Andrei — це експериментальний AI-асистент на сайті. Його відповіді мають інформаційний характер і не замінюють консультацію з ліцензованим агентом,
        юристом чи нотаріусом. Andrei може помилятися — усе, що впливає на угоду, підтверджуйте у відповідного фахівця, перш ніж діяти.
      </p>
