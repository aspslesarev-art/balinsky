...
export default function Page() {
  return (
    <LegalLayout lang="uk" title="Умови використання" updated={`Останнє оновлення: ${UPDATED}`} breadcrumbLabel="Умови використання">
      ...
      <h2>2. Чим Balinsky.info не є</h2>
      <p>
      ...
      <p>
        Спори регулюються законодавством Грузії, якщо імперативні норми країни вашого проживання
