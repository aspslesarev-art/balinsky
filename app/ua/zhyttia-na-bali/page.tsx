...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/ua/zhyttia-na-bali',
    languages: {
      ru: `${SITE_URL}/ru/zhizn-na-bali`,
      uk: `${SITE_URL}/ua/zhyttia-na-bali`,
...
export default function Page() {
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Living in Bali', item: `${SITE_URL}/ua/zhyttia-na-bali` },
    ],
  }
  const faqJsonLd = {
    '@context': 'https://schema.org',
        ...
        <article className="mt-6 mb-16 max-w-4xl">
          ...
          <section className="mb-12">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <Link href="/ua/vily/umalas" className="block rounded-2xl border border-[var(--color-border)] p-5 bg-white no-underline hover:border-[var(--color-primary)] transition-colors">
              ...
              <Link href="/ua/vily/sanur" className="block rounded-2xl border border-[var(--color-border)] p-5 bg-white no-underline hover:border-[var(--color-primary)] transition-colors">
              ...
              <Link href="/ua/kontakty" className="block rounded-2xl border border-[var(--color-border)] p-5 bg-white no-underline hover:border-[var(--color-primary)] transition-colors">
