...
export default function Page() {
  return (
    <LegalLayout lang="de" title="Contact" updated={`Information current as of: ${UPDATED}`} breadcrumbLabel="Contact">
      <p>
      ...
      <ul>
        <li><Link href="/de/datenschutz">Privacy Policy</Link></li>
        <li><Link href="/de/agb">Terms of Use</Link></li>
        <li><Link href="/de/ueber-uns">About Balinsky</Link></li>
      </ul>
    </LegalLayout>
  )
}
