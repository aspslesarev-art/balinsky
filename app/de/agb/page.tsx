...
export default function Page() {
  return (
    <LegalLayout lang="de" title="Nutzungsbedingungen" updated={`Zuletzt aktualisiert: ${UPDATED}`} breadcrumbLabel="Nutzungsbedingungen">
      ...
      <h2>5. KI-Assistent Andrei</h2>
      <p>
        Andrei ist ein experimenteller KI-Assistent auf der Website. Ihre Antworten dienen der Information und ersetzen keine Beratung durch einen zugelassenen Makler,
        Anwalt oder Notar. Andrei kann Fehler machen — lassen Sie alles, was einen Abschluss betrifft, vor dem Handeln durch den entsprechenden Fachmann bestätigen.
      </p>
