...
export default function Page() {
  return (
    <LegalLayout lang="id" title="Contact" updated={`Information current as of: ${UPDATED}`} breadcrumbLabel="Contact">
      <p>
      ...
      <ul>
        <li><Link href="/id/privasi">Privacy Policy</Link></li>
        <li><Link href="/id/ketentuan">Terms of Use</Link></li>
        <li><Link href="/id/tentang">About Balinsky</Link></li>
      </ul>
    </LegalLayout>
  )
}
