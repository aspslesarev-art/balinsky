  ...
  return (
    <>
      ...
      <PageContainer>
        ...
        <div className="mt-4">
          <ComplexFiltersBar state={filters} options={options} view="map" lang="id" />
        </div>

        <div className="mt-6">
          <ComplexesMap apiKey={apiKey} groups={groups} heatCells={heat.cells} heatMax={heat.max} lang="id" />
        </div>

        <ComplexesSeoContent filters={filters} variant="map" lang="id" />
