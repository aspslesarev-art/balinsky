...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      en: `${SITE_URL}/id/investasi-properti-bali`,
        ...
        <article className="mt-6 mb-16 max-w-4xl">
          ...
          <section className="mb-12">
            ...
            <p className="mt-4 text-[14px] text-[var(--color-text-muted)]">
              Full transaction guide on the <Link href="/id/cara-beli" className="text-[var(--color-primary)] no-underline hover:underline">«How to buy property in Bali»</Link> page.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="mt-6 text-[14px]">
              More on <Link href="/id/tentang" className="text-[var(--color-primary)] no-underline hover:underline">«About Balinsky»</Link>.
            </div>
          </section>
