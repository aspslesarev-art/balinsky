...
export default function Page() {
  return (
    <LegalLayout lang="fr" title="Cookie Policy" updated={`Last updated: ${UPDATED}`} breadcrumbLabel="Cookie Policy">
      <p>
      ...
      <ul>
        <li><a href="/fr/confidentialite">Privacy Policy</a></li>
        <li><a href="/fr/conditions">Terms of Use</a></li>
      </ul>
