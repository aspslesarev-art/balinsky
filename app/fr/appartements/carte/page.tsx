  ...
  return (
    <>
      ...
      <PageContainer>
        ...
        <div className="mt-4">
          <FiltersBar state={filters} options={options} view="map" lang="fr" />
        </div>

        <div className="mt-6">
          <ApartmentsMap apiKey={apiKey} groups={groups} heatCells={heat.cells} heatMax={heat.max} lang="fr" />
        </div>

        <SeoContent filters={filters} variant="map" lang="fr" />
