...
export default function Page() {
  return (
    <LegalLayout lang="fr" title="Terms of Use" updated={`Last updated: ${UPDATED}`} breadcrumbLabel="Terms of Use">
      <p>
      ...
      <p>
        ...
        right to share them. How that data is used: see our <a href="/fr/confidentialite">Privacy Policy</a>.
      </p>
      <p>
