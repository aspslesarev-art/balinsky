...
export default function Page() {
  return (
    <LegalLayout lang="fr" title="Politique de confidentialité" updated={`Dernière mise à jour : ${UPDATED}`} breadcrumbLabel="Politique de confidentialité">
      ...
      <p>
        Balinsky.info est un projet d’information à titre privé. Pour toute demande relative à la protection des données : <a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a>,
      ...
      <ul>
        ...
        <li><strong>OpenAI / Azure OpenAI</strong> — moteur de l&apos;assistant IA Andrei. Si vous écrivez à l&apos;assistant, votre message et son contexte immédiat sont transmis à l&apos;API du prestataire.</li>
      </ul>
