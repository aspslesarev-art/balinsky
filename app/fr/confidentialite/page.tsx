...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      en: `${SITE_URL}/fr/confidentialite`,
...
export default function Page() {
  return (
    <LegalLayout lang="fr" title="Privacy Policy" updated={`Last updated: ${UPDATED}`} breadcrumbLabel="Privacy Policy">
      <p>
        This policy explains what personal data the site <a href="/fr">Balinsky.info</a> collects, why,
      ...
      <ul>
        ...
        <li>Cookies — see the <a href="/fr/cookie">Cookie Policy</a> for details.</li>
      </ul>
