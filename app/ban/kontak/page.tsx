...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/ban/kontak',
    languages: {
      ru: `${SITE_URL}/ru/kontakty`,
      en: `${SITE_URL}/ban/kontak`,
...
export default function Page() {
  return (
    <LegalLayout lang="ban" title="Contact" updated={`Information current as of: ${UPDATED}`} breadcrumbLabel="Contact">
      ...
      <ul>
        <li><Link href="/ban/privasi">Privacy Policy</Link></li>
        <li><Link href="/ban/ketentuan">Terms of Use</Link></li>
        <li><Link href="/ban/indik">About Balinsky</Link></li>
      </ul>
    </LegalLayout>
  )
}
