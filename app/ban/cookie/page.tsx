...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/ban/cookie',
    languages: {
      ru: `${SITE_URL}/ru/cookie`,
      en: `${SITE_URL}/ban/cookie`,
...
export default function Page() {
  return (
    <LegalLayout lang="ban" title="Cookie Policy" updated={`Last updated: ${UPDATED}`} breadcrumbLabel="Cookie Policy">
      <p>
      ...
      <ul>
        <li><a href="/ban/privasi">Privacy Policy</a></li>
        <li><a href="/ban/ketentuan">Terms of Use</a></li>
      </ul>
