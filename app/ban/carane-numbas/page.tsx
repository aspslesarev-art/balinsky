...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/ban/carane-numbas',
    languages: { ru: `${SITE_URL}/ru/kak-kupit`, en: `${SITE_URL}/ban/carane-numbas` , 'x-default': `${SITE_URL}/ru/kak-kupit`},
  },
  openGraph: {
    ...
    url: `${SITE_URL}/ban/carane-numbas`,
    type: 'article',
  },
}

export default function Page() {
  return <BuyingGuide lang="ban" />
}
