...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/ban/ketentuan',
    languages: {
      ru: `${SITE_URL}/ru/usloviya`,
      en: `${SITE_URL}/ban/ketentuan`,
...
export default function Page() {
  return (
    <LegalLayout lang="ban" title="Terms of Use" updated={`Last updated: ${UPDATED}`} breadcrumbLabel="Terms of Use">
      <p>
      ...
      <p>
        ...
        right to share them. How that data is used: see our <a href="/ban/privasi">Privacy Policy</a>.
      </p>
      <p>
