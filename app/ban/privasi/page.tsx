...
export default function Page() {
  return (
    <LegalLayout lang="ban" title="Privacy Policy" updated={`Last updated: ${UPDATED}`} breadcrumbLabel="Privacy Policy">
      <p>
        This policy explains what personal data the site <a href="/ban">Balinsky.info</a> collects, why,
      ...
      <ul>
        ...
        <li>Cookies — see the <a href="/ban/cookie">Cookie Policy</a> for details.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>OpenAI / Azure OpenAI</strong> — powering the Andrei AI assistant. If you message the assistant, your message and surrounding context are sent to the provider&apos;s API.</li>
      </ul>
