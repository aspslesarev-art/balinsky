...
// gets called by a Vercel cron and dispatches the workflow via the
// GitHub REST API. Idempotent — both schedules just enqueue runs,
...
// request. We compare against the env to keep the endpoint private.
//
// Required env (Vercel project):
//   CRON_SECRET            — random string, also set on Vercel cron
