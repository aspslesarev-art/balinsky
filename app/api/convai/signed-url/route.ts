...
// ElevenLabs key. The agent itself has no DB access — it just gathers the
// visitor's requirements fast; the actual search runs afterwards in the chat.
...
export async function GET(req: Request) {
  ...
  // agent_id is public (not a secret); the constant is the Балина call agent so
  // prod works with just ELEVENLABS_API_KEY, env override optional.
