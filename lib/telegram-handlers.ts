...
function defaultGreeting(): Reply {
  return {
    text:
      '<b>Привет! Я Андрей — AI-брокер по недвижимости на Бали.</b>\n\n' +
  ...
  return {
    reply: {
      text:
        ...
        'Вернитесь в браузер — на той же странице, откуда вы запросили код, уже открыто ' +
        'поле для ввода. Код одноразовый и действует 15 минут.\n\n' +
