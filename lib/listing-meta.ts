...
const TERMS: Record<Lang, Terms> = {
  ru: {
    ...
    devDesc: a => `${a.name} в цифрах: проекты, сроки сдачи, цены и статус разрешений PBG/SLF. ${a.total} ${pluralRu(a.total, ['проект', 'проекта', 'проектов'])} на Бали — ${a.ready} сдано, ${a.inProgress} строится.`,
    devTitleBare: n => `${n} — застройщик на Бали: проекты, сроки, отзывы`,
  ...
  en: {
    ...
    devDesc: a => `${a.name} in numbers: projects, handover dates, prices and PBG/SLF permit status. ${a.total} Bali ${two(a.total, 'project', 'projects')} — ${a.ready} delivered, ${a.inProgress} under construction.`,
    devTitleBare: n => `${n} — Bali developer: projects, track record, reviews`,
  ...
  id: {
    ...
    units: n => `${n} unit`,
    devDesc: a => `${a.name} dalam angka: proyek, tanggal serah terima, harga, dan status izin PBG/SLF. ${a.total} proyek di Bali — ${a.ready} selesai, ${a.inProgress} dalam pembangunan.`,
    devTitleBare: n => `${n} — pengembang Bali: proyek, rekam jejak, ulasan`,
  ...
  fr: {
    ...
    devDesc: a => `${a.name} en chiffres : projets, dates de livraison, prix et statut des permis PBG/SLF. ${a.total} ${two(a.total, 'projet', 'projets')} à Bali — ${a.ready} ${two(a.ready, 'livré', 'livrés')}, ${a.inProgress} en construction.`,
    devTitleBare: n => `${n} — promoteur à Bali : projets, historique, avis`,
  ...
  de: {
    ...
    devDesc: a => `${a.name} in Zahlen: Projekte, Übergabetermine, Preise und PBG/SLF-Genehmigungsstatus. ${a.total} ${two(a.total, 'Projekt', 'Projekte')} auf Bali — ${a.ready} fertig, ${a.inProgress} im Bau.`,
    devTitleBare: n => `${n} — Bali-Bauträger: Projekte, Erfahrung, Bewertungen`,
  ...
  zh: {
    ...
    building: n => `在建${n}个`,
    units: n => `${n}套`,
    devDesc: a => `${a.name} 数据一览：项目、交付日期、价格及 PBG/SLF 许可状态。巴厘岛${a.total}个项目，已交付${a.ready}个，在建${a.inProgress}个。`,
    devTitleBare: n => `${n} — 巴厘岛开发商：项目、业绩与评价`,
  ...
  nl: {
    ...
    units: n => `${n} units`,
    devDesc: a => `${a.name} in cijfers: projecten, opleverdata, prijzen en status van PBG/SLF-vergunningen. ${a.total} ${two(a.total, 'project', 'projecten')} op Bali — ${a.ready} opgeleverd, ${a.inProgress} in aanbouw.`,
    devTitleBare: n => `${n} — Bali-ontwikkelaar: projecten, trackrecord, reviews`,
  ...
  ban: {
    ...
    units: n => `${n} unit`,
    devDesc: a => `${a.name} ring angka: proyek, tanggal puput, aji, miwah status izin PBG/SLF. ${a.total} proyek ring Bali — ${a.ready} puput, ${a.inProgress} kantun kawangun.`,
    devTitleBare: n => `${n} — pangwangun Bali: proyek, rekam jejak, ulasan`,
  ...
  pl: {
    ...
    devDesc: a => `${a.name} w liczbach: inwestycje, terminy oddania, ceny i status pozwoleń PBG/SLF. ${a.total} ${pluralPl(a.total, ['inwestycja', 'inwestycje', 'inwestycji'])} na Bali — ${a.ready} ${pluralPl(a.ready, ['oddana', 'oddane', 'oddanych'])}, ${a.inProgress} w budowie.`,
    devTitleBare: n => `${n} — deweloper na Bali: inwestycje, historia, opinie`,
  ...
  uk: {
    ...
    devDesc: a => `${a.name} у цифрах: проєкти, терміни здачі, ціни та статус дозволів PBG/SLF. ${a.total} ${pluralRu(a.total, ['проєкт', 'проєкти', 'проєктів'])} на Балі — ${a.ready} здано, ${a.inProgress} будується.`,
    devTitleBare: n => `${n} — забудовник на Балі: проєкти, терміни, відгуки`,
