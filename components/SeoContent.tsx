...
const COPY = {
  ru: {
    ...
    ctxDefault: 'Бали — один из самых динамичных рынков апартаментов в Юго-Восточной Азии: новые комплексы вводятся ежемесячно, медианный апартамент с одной спальней, по расчёту Balinsky, даёт около 9% годовых валовых при загрузке 65%. Основные локации: Чангу (Berawa, Batu Bolong, Pererenan) для сёрфинга и удалённой работы, Убуд для жизни в природе, Букит (Uluwatu, Pandawa) для премиальных видов на океан, Санур и Нуса-Дуа для семейного формата.',
    ...
    faq: [
      ...
      { q: 'Какую доходность приносит сдача в аренду?',
        a: 'По расчёту Balinsky (сентябрь 2026, 345 апартаментов с одной спальней на продаже и 300 апартаментов в аренде) медианный апартамент с одной спальней при загрузке 65% даёт около 9% годовых валовых и около 4,4% чистыми. Загрузка звёздных отелей Бали — примерно 57–65% (BPS Bali).' },
    ],
  },
  en: {
    ...
    ctxDefault: 'Bali is one of the most dynamic apartment markets in South-East Asia: new complexes deliver monthly, a median one-bedroom apartment earns about 9% a year gross at 65% occupancy by Balinsky\'s calculation. Key areas: Canggu (Berawa, Batu Bolong, Pererenan) for surf and remote work, Ubud for life in nature, Bukit (Uluwatu, Pandawa) for premium ocean views, Sanur and Nusa Dua for family-friendly stays.',
    ...
    faq: [
      ...
      { q: 'What rental yield can be expected?',
        a: 'By Balinsky\'s calculation (September 2026, 345 one-bedroom apartments for sale and 300 apartments for rent), a median one-bedroom apartment earns about 9% gross and 4.4% net a year at 65% occupancy. Star hotels on Bali run at roughly 57–65% occupancy (BPS Bali).' },
    ],
  },
  id: {
    introWhereDistrict: (d: string) => `${d}`,
    ...
    ctxDefault: 'Bali adalah salah satu pasar apartemen paling dinamis di Asia Tenggara: kompleks baru diserahkan setiap bulan, apartemen 1 kamar tidur median, menurut perhitungan Balinsky, menghasilkan sekitar 9% per tahun kotor pada okupansi 65%. Kawasan utama: Canggu (Berawa, Batu Bolong, Pererenan) untuk selancar dan kerja jarak jauh, Ubud untuk hidup di alam, Bukit (Uluwatu, Pandawa) untuk pemandangan laut premium, Sanur dan Nusa Dua untuk suasana ramah keluarga.',
    ...
    faq: [
      ...
      { q: 'Berapa imbal hasil sewa yang bisa diharapkan?',
        a: 'Menurut perhitungan Balinsky (September 2026, 345 apartemen 1 kamar tidur dijual dan 300 apartemen disewakan), apartemen 1 kamar tidur median menghasilkan sekitar 9% kotor dan 4,4% bersih per tahun pada okupansi 65%. Okupansi hotel berbintang di Bali sekitar 57–65% (BPS Bali).' },
    ],
  },
  fr: {
    introWhereDistrict: (d: string) => `${d}`,
    ...
    ctxDefault: 'Bali est l’un des marchés d’appartements les plus dynamiques d’Asie du Sud-Est : de nouvelles résidences sont livrées chaque mois, un appartement médian d’une chambre rapporte environ 9 % brut par an à 65 % d’occupation selon le calcul de Balinsky. Zones clés : Canggu (Berawa, Batu Bolong, Pererenan) pour le surf et le travail à distance, Ubud pour la vie au cœur de la nature, Bukit (Uluwatu, Pandawa) pour les vues premium sur l’océan, Sanur et Nusa Dua pour les séjours en famille.',
    ...
    faq: [
      ...
      { q: 'Quel rendement locatif peut-on espérer ?',
        a: 'Selon le calcul de Balinsky (septembre 2026, 345 appartements d\'une chambre à vendre et 300 appartements en location), un appartement médian d\'une chambre rapporte environ 9 % brut et 4,4 % net par an à 65 % d\'occupation. Les hôtels étoilés de Bali affichent environ 57–65 % d\'occupation (BPS Bali).' },
    ],
  },
  de: {
    introWhereDistrict: (d: string) => `${d}`,
    ...
    ctxDefault: 'Bali ist einer der dynamischsten Apartmentmärkte Südostasiens: Neue Anlagen werden monatlich fertiggestellt, ein mittleres Apartment mit einem Schlafzimmer erzielt nach Berechnung von Balinsky bei 65 % Auslastung etwa 9 % brutto pro Jahr. Wichtige Gebiete: Canggu (Berawa, Batu Bolong, Pererenan) für Surfen und Remote-Arbeit, Ubud für das Leben in der Natur, Bukit (Uluwatu, Pandawa) für Premium-Meerblick, Sanur und Nusa Dua für familienfreundliche Aufenthalte.',
    ...
    faq: [
      ...
      { q: 'Welche Mietrendite ist zu erwarten?',
        a: 'Nach Berechnung von Balinsky (September 2026, 345 Apartments mit einem Schlafzimmer im Verkauf und 300 Apartments in der Vermietung) erzielt ein mittleres Apartment mit einem Schlafzimmer bei 65 % Auslastung etwa 9 % brutto und 4,4 % netto pro Jahr. Sternehotels auf Bali sind zu etwa 57–65 % ausgelastet (BPS Bali).' },
    ],
  },
  zh: {
    introWhereDistrict: (d: string) => `${d}`,
    ...
    ctxDefault: '巴厘岛是东南亚最具活力的公寓市场之一：每月都有新项目交付，根据 Balinsky 测算，中位数一居室公寓在 65% 入住率下年毛收益约 9%。主要区域：Canggu（Berawa、Batu Bolong、Pererenan）适合冲浪与远程办公，Ubud 适合亲近自然的生活，Bukit（Uluwatu、Pandawa）拥有高端海景，Sanur 与 Nusa Dua 适合家庭出行。',
    ...
    faq: [
      ...
      { q: '可以预期多少租金收益？',
        a: '根据 Balinsky 测算（2026 年 9 月，在售一居室公寓 345 套、出租公寓 300 套），中位数一居室公寓在 65% 入住率下年毛收益约 9%、净收益约 4.4%。巴厘岛星级酒店入住率约为 57–65%（BPS Bali）。' },
    ],
  },
  nl: {
    introWhereDistrict: (d: string) => `${d}`,
    ...
    faq: [
      ...
      { q: 'Welk huurrendement is te verwachten?',
        a: 'Volgens de berekening van Balinsky (september 2026, 345 appartementen met één slaapkamer te koop en 300 appartementen te huur) levert een mediaan appartement met één slaapkamer bij 65% bezetting ongeveer 9% bruto en 4,4% netto per jaar op. Sterrenhotels op Bali draaien op ongeveer 57–65% bezetting (BPS Bali).' },
    ],
  },
  ban: {
    introWhereDistrict: (d: string) => `${d}`,
    ...
    ctxDefault: 'Bali inggih punika silih tunggil pasar apartemen sane pinih dinamis ring Asia Tenggara: kompleks anyar kaserahang nyabran bulan, apartemen 1 kamar median, manut itungan Balinsky, ngasilang sawatara 9% setahun kotor ring okupansi 65%. Wewengkon utama: Canggu (Berawa, Batu Bolong, Pererenan) antuk selancar lan makarya jarak jauh, Ubud antuk urip ring alam, Bukit (Uluwatu, Pandawa) antuk pemandangan pasih premium, Sanur lan Nusa Dua antuk suasana becik ring kulawarga.',
    ...
    faq: [
      ...
      { q: 'Asil sewa sapunapi sane prasida kaajap?',
        a: 'Manut itungan Balinsky (September 2026, 345 apartemen 1 kamar kaadol miwah 300 apartemen kasewaang), apartemen 1 kamar median ngasilang sawatara 9% kotor lan 4,4% bersih setahun ring okupansi 65%. Okupansi hotel bintang ring Bali sawatara 57–65% (BPS Bali).' },
    ],
  },
  pl: {
    introWhereDistrict: (d: string) => `${d}`,
    ...
    ctxDefault: 'Bali to jeden z najbardziej dynamicznych rynków apartamentów w Azji Południowo-Wschodniej: nowe kompleksy oddawane są co miesiąc, mediana apartamentu z jedną sypialnią według wyliczeń Balinsky daje około 9% rocznie brutto przy obłożeniu 65%. Kluczowe rejony: Canggu (Berawa, Batu Bolong, Pererenan) dla surfingu i pracy zdalnej, Ubud dla życia w naturze, Bukit (Uluwatu, Pandawa) dla widoków na ocean klasy premium, Sanur i Nusa Dua dla pobytów rodzinnych.',
    ...
    faq: [
      ...
      { q: 'Jakiej rentowności najmu można się spodziewać?',
        a: 'Według wyliczeń Balinsky (wrzesień 2026, 345 apartamentów z jedną sypialnią na sprzedaż i 300 apartamentów na wynajem) mediana apartamentu z jedną sypialnią przy obłożeniu 65% daje około 9% brutto i 4,4% netto rocznie. Obłożenie hoteli z gwiazdkami na Bali to około 57–65% (BPS Bali).' },
    ],
  },
  uk: {
    introWhereDistrict: (d: string) => `${d}`,
    ...
    ctxDefault: 'Балі — один із найдинамічніших ринків апартаментів у Південно-Східній Азії: нові комплекси здаються щомісяця, медіанний апартамент з однією спальнею, за розрахунком Balinsky, дає близько 9% річних валових при заповнюваності 65%. Основні локації: Чангу (Berawa, Batu Bolong, Pererenan) для серфінгу та віддаленої роботи, Убуд для життя серед природи, Букіт (Uluwatu, Pandawa) для преміальних краєвидів на океан, Санур і Нуса-Дуа для сімейного відпочинку.',
    ...
    faq: [
      ...
      { q: 'Яку дохідність приносить здавання в оренду?',
        a: 'За розрахунком Balinsky (вересень 2026, 345 апартаментів з однією спальнею на продажу і 300 апартаментів в оренді) медіанний апартамент з однією спальнею при заповнюваності 65% дає близько 9% валових і 4,4% чистими на рік. Заповнюваність зіркових готелів Балі — приблизно 57–65% (BPS Bali).' },
    ],
  },
} as const
