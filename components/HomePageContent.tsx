...
const COPY = {
  ...
  pl: {
    locale: 'pl-PL',
    h2: 'Nieruchomości na Bali — bez pośredników i pustych obietnic',
    intro: (totalUnits: number, complexes: number, developers: number) =>
      `${totalUnits} ofert i ${complexes} kompleksów mieszkaniowych od ${developers} deweloperów. Przejrzyste dane o pozwoleniach i firmach zarządzających, świeże promocje, aktualności i wydarzenia.`,
    sectionVillas:     { title: 'Wille i domy',           tagline: 'Wolnostojące domy z działką, basenem i prywatnym terenem',  countLabel: 'ofert' },
    sectionApartments: { title: 'Apartamenty',            tagline: 'Lokale w nowoczesnych kompleksach z firmą zarządzającą',   countLabel: 'ofert' },
    sectionComplexes:  { title: 'Kompleksy mieszkaniowe', tagline: 'Zamknięte kompleksy z infrastrukturą i obsługą',           countLabel: 'kompleksów' },
    sectionDevelopers: { title: 'Deweloperzy',            tagline: 'Oceny, oddane projekty, historia prawna',                  countLabel: 'firm' },
    topVillasTitle:   'Wille o najlepszym potencjale inwestycyjnym',
    topVillasLink:    'Wszystkie wille',
    activePromoTitle: 'Promocje deweloperów',
    activePromoLink:  'Wszystkie promocje',
    eventsTitle:      'Nadchodzące wydarzenia',
    eventsLink:       'Wszystkie wydarzenia',
    complexesTitle:   'Kompleksy mieszkaniowe',
    complexesLink:    'Wszystkie kompleksy',
    newsTitle:        'Najnowsze aktualności',
    newsLink:         'Wszystkie aktualności',
    districtsTitle:   'Popularne regiony',
    districtsIntro:   'Canggu (Berawa, Pererenan, Batu Bolong) — surfing i wynajem; Bukit (Uluwatu, Pandawa) — widoki premium; Ubud — życie w naturze; Sanur — format rodzinny.',
    knowledgeBadge:   'Baza wiedzy',
    knowledgeTitle:   'Leasehold, podatki, pobyt i życie na Bali — praktyczne poradniki',
    knowledgeCta:     'Otwórz bazę wiedzy',
    seoH2:            'Nieruchomości na Bali — co warto wiedzieć',
    seoP1:            'Bali to jeden z najbardziej dynamicznych rynków nieruchomości w Azji Południowo-Wschodniej. Co miesiąc rusza budowa nowych kompleksów mieszkaniowych, aktywni deweloperzy prowadzą kilka inwestycji naraz. Rentowność z najmu krótkoterminowego przez firmę zarządzającą wynosi średnio 8–12% rocznie w wysokim sezonie.',
    seoP2:            'Większość transakcji zamyka się jako leasehold (25–80 lat z możliwością przedłużenia), rzadziej przez indonezyjską spółkę PT PMA. Dokumenty budowlane: PBG (pozwolenie na budowę) i SLF (certyfikat użytkowania). Bez SLF lokalu nie można legalnie wynajmować — to kluczowa kontrola przed zakupem oddanej nieruchomości.',
    faqTitle:         'Najczęściej zadawane pytania',
    faq: [
      { q: 'Od czego zacząć wybór nieruchomości na Bali?', a: 'Najpierw wybierz format: wille i domy w zabudowie szeregowej w Canggu, Sanur lub Ubud do mieszkania; apartamenty w budowanych kompleksach z firmą zarządzającą pod dochód z najmu; lokale z widokiem premium na Bukit pod odsprzedaż.' },
      { q: 'Czy obcokrajowiec może kupić nieruchomość na Bali?', a: 'Tak — przez leasehold (długoterminowa dzierżawa gruntu, zwykle 25–80 lat) lub przez indonezyjską spółkę PT PMA. Transakcję zamyka się u notariusza PPAT.' },
      { q: 'Jakiej rentowności najmu można się spodziewać?', a: 'W Canggu i na Bukit to 8–12% rocznie przy obłożeniu 70–80% przez firmę zarządzającą. Zależy od regionu, typu nieruchomości i sezonowości.' },
      { q: 'Czym są PBG i SLF?', a: 'PBG to pozwolenie na budowę — bez niego budowa jest nielegalna. SLF to certyfikat użytkowania — bez niego lokalu nie można oficjalnie wynajmować.' },
    ],
    until:            (d: string) => `Do ${d}`,
    unitsSuffix:      'lokali',
    orgDescription:   'Katalog nieruchomości na Bali: wille, apartamenty, kompleksy mieszkaniowe i zweryfikowani deweloperzy.',
  },
  uk: {
    locale: 'uk-UA',
    h2: 'Нерухомість на Балі — без посередників і гарних обіцянок',
    intro: (totalUnits: number, complexes: number, developers: number) =>
      `${totalUnits} оголошень і ${complexes} житлових комплексів від ${developers} забудовників. Прозорі дані про дозволи та керуючі компанії, свіжі акції, новини та події.`,
    sectionVillas:     { title: 'Вілли та будинки',    tagline: 'Окремі будинки з ділянкою, басейном і приватною територією', countLabel: 'об’єктів' },
    sectionApartments: { title: 'Апартаменти',         tagline: 'Юніти в сучасних комплексах з керуючою компанією',           countLabel: 'об’єктів' },
    sectionComplexes:  { title: 'Житлові комплекси',   tagline: 'Закриті комплекси з інфраструктурою та сервісом',            countLabel: 'комплексів' },
    sectionDevelopers: { title: 'Забудовники',         tagline: 'Рейтинги, здані проєкти, юридична репутація',                countLabel: 'компаній' },
    topVillasTitle:   'Вілли з найкращим інвестиційним потенціалом',
    topVillasLink:    'Усі вілли',
    activePromoTitle: 'Акції від забудовників',
    activePromoLink:  'Усі акції',
    eventsTitle:      'Найближчі події',
    eventsLink:       'Усі події',
    complexesTitle:   'Житлові комплекси',
    complexesLink:    'Усі комплекси',
    newsTitle:        'Свіжі новини',
    newsLink:         'Усі новини',
    districtsTitle:   'Популярні регіони',
    districtsIntro:   'Canggu (Berawa, Pererenan, Batu Bolong) — серфінг і оренда; Bukit (Uluwatu, Pandawa) — краєвиди преміум; Ubud — життя серед природи; Sanur — сімейний формат.',
    knowledgeBadge:   'База знань',
    knowledgeTitle:   'Leasehold, податки, ВНЖ і життя на Балі — практичні гайди',
    knowledgeCta:     'Відкрити базу знань',
    seoH2:            'Нерухомість на Балі — що важливо знати',
    seoP1:            'Балі — один із найдинамічніших ринків нерухомості Південно-Східної Азії. Щомісяця закладають нові житлові комплекси, активні забудовники ведуть кілька майданчиків одночасно. Дохідність від подобової оренди через керуючу компанію в середньому 8–12% на рік у високий сезон.',
    seoP2:            'Більшість угод оформлюють як leasehold (25–80 років з можливістю продовження), рідше — через індонезійську юрособу PT PMA. Будівельні документи: PBG (дозвіл на будівництво) і SLF (сертифікат придатності). Без SLF юніт не можна легально здавати в оренду — важлива перевірка перед купівлею зданого об’єкта.',
    faqTitle:         'Часті запитання',
    faq: [
      { q: 'З чого почати вибір нерухомості на Балі?', a: 'Спершу визначте формат: вілли й таунхауси в Canggu, Sanur чи Ubud для життя; апартаменти в комплексах на етапі будівництва з керуючою компанією для доходу від оренди; юніти з краєвидами преміум на Bukit для перепродажу.' },
      { q: 'Чи може іноземець купити нерухомість на Балі?', a: 'Так — через leasehold (довгострокова оренда землі, зазвичай 25–80 років) або через індонезійську компанію PT PMA. Угоду оформлюють у нотаріуса PPAT.' },
      { q: 'На яку дохідність від оренди можна розраховувати?', a: 'У Canggu та на Bukit це 8–12% річних за завантаження 70–80% через керуючу компанію. Залежить від регіону, типу об’єкта та сезонності.' },
      { q: 'Що таке PBG і SLF?', a: 'PBG — це дозвіл на будівництво: без нього будівництво незаконне. SLF — сертифікат придатності: без нього юніт не можна офіційно здавати в оренду.' },
    ],
    until:            (d: string) => `До ${d}`,
    unitsSuffix:      'юнітів',
    orgDescription:   'Каталог нерухомості на Балі: вілли, апартаменти, житлові комплекси та перевірені забудовники.',
  },
} as const
