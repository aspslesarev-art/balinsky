...
const COPY = {
  ...
  pl: {
    title: 'Co można zrobić z tą działką',
    summarySub: 'Z oficjalnej mapy zagospodarowania Indonezji (RDTR)',
    expand: 'Pokaż szczegóły',
    collapse: 'Ukryj szczegóły',
    str: 'Najem krótkoterminowy',
    useCases: 'Co można wybudować i wynająć',
    hotel: 'Hotel',
    villa: 'Willa',
    kos: 'Pensjonat',
    restaurant: 'Restauracja',
    kabupaten: 'Regencja (kabupaten)',
    kecamatan: 'Dystrykt (kecamatan)',
    desa: 'Wieś (desa)',
    zone: 'Kategoria strefy',
    subzone: 'Typ strefy',
    kdb: 'Maks. zabudowa działki',
    kdbHint: 'KDB — jaką część działki może zająć budynek. Reszta musi pozostać jako podwórze, ogród lub parking.',
    klb: 'Maks. łączna powierzchnia kondygnacji',
    klbHint: 'KLB (wskaźnik intensywności zabudowy) — ile razy łączna powierzchnia wszystkich kondygnacji może przekraczać powierzchnię działki. 2× ≈ jedna kondygnacja na pełnej zabudowie lub dwie na połowie.',
    kdh: 'Min. teren zielony',
    kdhHint: 'KDH — część działki, która musi pozostać niezabudowana i nieutwardzona (trawnik, rośliny, grunt przepuszczalny).',
    ktb: 'Maks. powierzchnia piwnicy',
    ktbHint: 'KTB — jaką część działki może zająć piwnica. Piwnice są na Bali rzadkie ze względu na wody gruntowe.',
    gsb: 'Odsunięcie od drogi',
    gsbHint: 'GSB — minimalna odległość od linii rozgraniczającej drogi do fasady budynku. Często zależy od szerokości drogi.',
    height: 'Maks. wysokość budynku',
    uses: 'Liczba dozwolonych typów użytkowania',
    regulation: 'Regulacja (Perda)',
    pdfPerda: 'Mapa zagospodarowania (PP)',
    pdfBody: 'Tekst regulacji (BT)',
    pdfVerification: 'Certyfikat weryfikacji (CT)',
    documents: 'Dokumenty urzędowe',
    homogeneityUniform: 'Strefa jednorodna',
    homogeneityMixed: 'Granica stref',
    mixedZonesNote: (zones: string) => `Działka leży na granicy między strefami (${zones}) — sprawdź ręcznie, która strefa obowiązuje w dokładnym punkcie.`,
    religiousTitle: '🛕 Balijska zasada: świątynia w pobliżu',
    religiousNote: 'Bhisama Kesucian Pura wymaga co najmniej 25 m od świątyni wiejskiej dla budynków jednokondygnacyjnych i 50 m dla budynków dwu- lub wielokondygnacyjnych. Sprawdź odległość do najbliższej pury.',
    selfCheckTitle: 'Zweryfikuj na oficjalnych mapach',
    selfCheckHint: 'Każdy link otwiera współrzędne tego kompleksu na niezależnej mapie zagospodarowania / katastralnej',
    gistaru: 'GISTARU (zagospodarowanie)',
    bhumi: 'BHUMI (kataster)',
    simtaru: 'SIMTARU (Bali)',
    threeDatu: '3Datu (Badung)',
    trustScore: 'Wiarygodność danych',
    trustHint: '0–100. Uwzględnia jednorodność strefy, dostępność dokumentów oraz brak „skomplikowanych” statusów użytkowania.',
    none: '—',
    strYes: 'dozwolone',
    strNo: 'niedozwolone',
    strMaybe: 'sprawdź przed zakupem',
    statusAllowed: 'można',
    statusLimited: 'z ograniczeniami',
    statusConditional: 'z pozwoleniami',
    statusLimitedConditional: 'z ograniczeniami + pozwolenia',
    statusForbidden: 'nie można',
    statusUnknown: 'brak danych',
  },
  uk: {
    title: 'Що можна робити з ділянкою',
    summarySub: 'За офіційною картою зонування Індонезії (RDTR)',
    expand: 'Докладніше',
    collapse: 'Згорнути',
    str: 'Здавати подобово',
    useCases: 'Що можна побудувати й здавати',
    hotel: 'Готель',
    villa: 'Вілла',
    kos: 'Гестхаус',
    restaurant: 'Ресторан',
    kabupaten: 'Регіон (kabupaten)',
    kecamatan: 'Район (kecamatan)',
    desa: 'Село (desa)',
    zone: 'Категорія зони',
    subzone: 'Тип зони',
    kdb: 'Макс. площа забудови ділянки',
    kdbHint: 'KDB — яку частку ділянки може зайняти будівля. Решта — двір, сад, паркування.',
    klb: 'Макс. сумарна площа будівель',
    klbHint: 'KLB (коефіцієнт використання) — у скільки разів загальна площа всіх поверхів може перевищувати площу ділянки. 2× ≈ один поверх на 100% або два поверхи по 50%.',
    kdh: 'Мінімум зеленої зони',
    kdhHint: 'KDH — яка частина ділянки має залишитися без забудови й без покриття (газон, насадження, проникний ґрунт).',
    ktb: 'Підвал — макс. площа',
    ktbHint: 'KTB — яку частку ділянки може займати підвал. На Балі підвали роблять рідко через ґрунтові води.',
    gsb: 'Відступи від дороги',
    gsbHint: 'GSB — мінімальна відстань від червоної лінії дороги до фасаду. Часто залежить від ширини дороги.',
    height: 'Макс. висота будівель',
    uses: 'Скільки типів використання дозволено',
    regulation: 'Регламент (Perda)',
    pdfPerda: 'Карта зонування (PP)',
    pdfBody: 'Текст постанови (BT)',
    pdfVerification: 'Сертифікат верифікації (CT)',
    documents: 'Офіційні документи',
    homogeneityUniform: 'Зона однорідна',
    homogeneityMixed: 'Стик зон',
    mixedZonesNote: (zones: string) => `Ділянка потрапляє на межу зон (${zones}) — варто перевірити вручну, яка зона застосовується до конкретної точки.`,
    religiousTitle: '🛕 Балійське правило: храм поруч',
    religiousNote: 'За правилами Bhisama Kesucian Pura від сільського храму має бути не менше 25 м для одноповерхового будинку та 50 м для дво- й більше поверхових. Перевірте відстань до найближчої пури.',
    selfCheckTitle: 'Перевірити на офіційних картах',
    selfCheckHint: 'Кожне посилання відкриє точку цього ЖК на сторонній карті — для незалежної перевірки',
    gistaru: 'GISTARU (зонування)',
    bhumi: 'BHUMI (кадастр)',
    simtaru: 'SIMTARU (Балі)',
    threeDatu: '3Datu (Badung)',
    trustScore: 'Достовірність даних',
    trustHint: '0–100. Враховує: однорідність зони, наявність документів, відсутність «складних» статусів use-case-ів.',
    none: '—',
    strYes: 'легально',
    strNo: 'не легально',
    strMaybe: 'потрібна перевірка',
    statusAllowed: 'можна',
    statusLimited: 'з обмеженнями',
    statusConditional: 'за погодженням',
    statusLimitedConditional: 'з обмеженнями + погодженням',
    statusForbidden: 'не можна',
