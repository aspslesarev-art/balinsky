...
const COPY = {
  ...
  pl: {
    idleTitle: 'Otrzymuj powiadomienia Telegram o nowych ofertach pod ten filtr',
    idleSubtitle: 'Raz dziennie o 10:00 — tylko nowe obiekty, bez spamu.',
    button: 'Otwórz Telegram',
    openedTitle: 'Telegram otwarty — naciśnij Start w bocie',
    openedSubtitle: 'Subskrypcja aktywuje się, gdy tylko otworzysz czat bota i naciśniesz Start.',
    openAgain: 'Otwórz Telegram ponownie',
    errorPrefix: 'Nie udało się',
    errorNotSetUp: 'Powiadomienia są tymczasowo niedostępne',
  },
  uk: {
    idleTitle: 'Отримуйте сповіщення в Telegram про нові оголошення за цим фільтром',
    idleSubtitle: 'Раз на день о 10:00 — лише нові обʼєкти, без спаму.',
    button: 'Відкрити Telegram',
    openedTitle: 'Telegram відкрито — натисніть Start у боті',
    openedSubtitle: 'Підписка активується щойно ви відкриєте чат бота й натиснете Start.',
    openAgain: 'Відкрити Telegram ще раз',
    errorPrefix: 'Не вдалося',
    errorNotSetUp: 'Сповіщення тимчасово недоступні',
  },
} as const
