...
const COPY = {
  ...
  pl: {
    ...
    devsIn: (n: string) => `Deweloperzy w ${n}`,
    newIn: (n: string) => `Nowe inwestycje w ${n}`,
    allComplexes: 'Kompleksy mieszkaniowe Bali',
    relatedHeading: 'Powiązane',
    related: [
      { href: '/pl/complexes', label: 'Kompleksy mieszkaniowe Bali' },
      { href: '/pl/apartments', label: 'Apartamenty od deweloperów' },
      { href: '/pl/villas', label: 'Wille i domy' },
      { href: `/pl/apartments/${BEDROOM_TO_SLUG['1']}`, label: 'Apartamenty 1-sypialniane' },
      { href: `/pl/apartments/${BEDROOM_TO_SLUG['2']}`, label: 'Apartamenty 2-sypialniane' },
      { href: `/pl/apartments/${STATUS_TO_SLUG.building}`, label: 'Apartamenty w budowie' },
      { href: `/pl/apartments/${STATUS_TO_SLUG.built}`, label: 'Gotowe apartamenty' },
      { href: '/pl/apartments/100000-200000', label: 'Apartamenty $100k–200k' },
    ],
  ...
  uk: {
    ...
    devsIn: (n: string) => `Забудовники в ${n}`,
    newIn: (n: string) => `Новобудови в ${n}`,
    allComplexes: 'Житлові комплекси Балі',
    relatedHeading: 'За темою',
    related: [
      { href: '/ua/complexes', label: 'Житлові комплекси Балі' },
      { href: '/ua/apartments', label: 'Апартаменти від забудовників' },
      { href: '/ua/villas', label: 'Вілли та будинки' },
      { href: `/ua/apartments/${BEDROOM_TO_SLUG['1']}`, label: '1-кімнатні апартаменти' },
      { href: `/ua/apartments/${BEDROOM_TO_SLUG['2']}`, label: '2-кімнатні апартаменти' },
      { href: `/ua/apartments/${STATUS_TO_SLUG.building}`, label: 'Апартаменти, що будуються' },
      { href: `/ua/apartments/${STATUS_TO_SLUG.built}`, label: 'Готові апартаменти' },
      { href: '/ua/apartments/100000-200000', label: 'Апартаменти $100k–200k' },
    ],
