...
const COPY = {
  ...
  uk: {
    ...
    related: [
      { href: '/uk/complexes', label: 'Житлові комплекси Балі' },
      { href: '/uk/apartments', label: 'Апартаменти від забудовників' },
      { href: '/uk/villas', label: 'Вілли та будинки' },
      { href: `/uk/apartments/${BEDROOM_TO_SLUG['1']}`, label: '1-кімнатні апартаменти' },
      { href: `/uk/apartments/${BEDROOM_TO_SLUG['2']}`, label: '2-кімнатні апартаменти' },
      { href: `/uk/apartments/${STATUS_TO_SLUG.building}`, label: 'Апартаменти, що будуються' },
      { href: `/uk/apartments/${STATUS_TO_SLUG.built}`, label: 'Готові апартаменти' },
      { href: '/uk/apartments/100000-200000', label: 'Апартаменти $100k–200k' },
    ],
