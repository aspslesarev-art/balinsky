...
const COPY = {
  ru: {
    ...
    faq: [
      ...
      // Головной вопрос ценового кластера RU-спроса — единственное место, где
      // на него отвечаем (faqExtra в lib/hub-seo/villas/ru.ts его намеренно не
      // дублирует, иначе в FAQPage уедут две одинаковые Question). Цифры — те
      // же, что в таблице цен хаба: пересчёт по каталогу, а не «от 150 тыс.».
      { q: 'Сколько стоит вилла на Бали?',         a: 'Медиана по каталогу — 360 000 $, восемь из десяти вилл укладываются в 175 000–861 000 $. По спальням: односпальная — 188 000 $, двуспальная — 325 000 $, трёхспальная — 495 000 $, от четырёх спален — 890 000 $. Нижняя граница — около 80 000 $, верхняя — 6,5 млн $ за особняк на первой линии океана.' },
      ...
      { q: 'Какая доходность у виллы под аренду?', a: 'По расчёту Balinsky (сентябрь 2026, 359 вилл на продаже и 6 305 вилл в аренде) медианная вилла с двумя спальнями при загрузке 65% даёт около 10% годовых валовых и около 5% чистыми, с одной спальней — около 14% и 7%. Сезонность сильно влияет: декабрь–март и июль–август — пик.' },
  ...
  en: {
    ...
    faq: [
      ...
      { q: 'What yield do rental villas earn?',          a: 'By Balinsky\'s calculation (September 2026, 359 villas for sale and 6,305 villas for rent), a median two-bedroom villa earns about 10% gross and 5% net a year at 65% occupancy; a one-bedroom villa about 14% and 7%. Seasonality matters: Dec–Mar and Jul–Aug are peak.' },
  ...
  id: {
    ...
    faq: [
      ...
      { q: 'Berapa imbal hasil vila sewa?',          a: 'Menurut perhitungan Balinsky (September 2026, 359 vila dijual dan 6.305 vila disewakan), vila 2 kamar tidur median menghasilkan sekitar 10% kotor dan 5% bersih per tahun pada okupansi 65%; vila 1 kamar tidur sekitar 14% dan 7%. Musim berpengaruh: Des–Mar dan Jul–Agu adalah puncaknya.' },
  ...
  fr: {
    ...
    faq: [
      ...
      { q: 'Quel rendement offrent les villas en location ?',          a: 'Selon le calcul de Balinsky (septembre 2026, 359 villas à vendre et 6 305 villas en location), une villa médiane de deux chambres rapporte environ 10 % brut et 5 % net par an à 65 % d\'occupation ; une villa d\'une chambre environ 14 % et 7 %. La saisonnalité compte : déc.–mars et juil.–août sont les pics.' },
  ...
  de: {
    ...
    faq: [
      ...
      { q: 'Welche Rendite bringen Mietvillen?',          a: 'Nach Berechnung von Balinsky (September 2026, 359 Villen im Verkauf und 6.305 Villen in der Vermietung) erzielt eine mittlere Villa mit zwei Schlafzimmern bei 65 % Auslastung etwa 10 % brutto und 5 % netto pro Jahr, eine Villa mit einem Schlafzimmer etwa 14 % und 7 %. Die Saisonalität spielt eine Rolle: Dez.–März und Juli–Aug. sind Hochsaison.' },
  ...
  zh: {
    ...
    faq: [
      ...
      { q: '出租别墅的收益率是多少？',          a: '根据 Balinsky 测算（2026 年 9 月，在售别墅 359 套、出租别墅 6,305 套），中位数两居室别墅在 65% 入住率下年毛收益约 10%、净收益约 5%；一居室约为 14% 和 7%。季节性影响明显：12 月–3 月和 7 月–8 月为旺季。' },
  ...
  nl: {
    ...
    faq: [
      ...
      { q: "Welk rendement leveren huurvilla's op?",          a: 'Volgens de berekening van Balinsky (september 2026, 359 villa\'s te koop en 6.305 villa\'s te huur) levert een mediane villa met twee slaapkamers bij 65% bezetting ongeveer 10% bruto en 5% netto per jaar op; een villa met één slaapkamer ongeveer 14% en 7%. Seizoensinvloeden tellen mee: dec–mrt en jul–aug zijn piek.' },
  ...
  ban: {
    ...
    faq: [
      ...
      { q: 'Kuda imbal hasil vila sewa?',          a: 'Manut itungan Balinsky (September 2026, 359 vila kaadol miwah 6.305 vila kasewaang), vila 2 kamar median ngasilang sawatara 10% kotor lan 5% bersih setahun ring okupansi 65%; vila 1 kamar sawatara 14% lan 7%. Musim mapengaruh: Des–Mar lan Jul–Agu inggih punika puncaknyane.' },
  ...
  pl: {
    ...
    faq: [
      ...
      { q: 'Jaką rentowność dają wille pod wynajem?',          a: 'Według wyliczeń Balinsky (wrzesień 2026, 359 willi na sprzedaż i 6305 willi na wynajem) mediana willi z dwiema sypialniami przy obłożeniu 65% daje około 10% brutto i 5% netto rocznie; willa z jedną sypialnią około 14% i 7%. Sezonowość ma znaczenie: grudzień–marzec i lipiec–sierpień to szczyt.' },
  ...
  uk: {
    ...
    faq: [
      ...
      { q: 'Яку дохідність дають вілли під оренду?',          a: 'За розрахунком Balinsky (вересень 2026, 359 віл на продажу і 6 305 віл в оренді) медіанна віла з двома спальнями при заповнюваності 65% дає близько 10% валових і 5% чистими на рік; з однією спальнею — близько 14% і 7%. Сезонність важлива: грудень–березень і липень–серпень — пік.' },
...
export function VillasSeoContent({
  ...
  // lib/hub-seo/types.ts on why the filtered pages must not.
  const longCopy = variant === 'list' && isUnfilteredHub(filters)
    ? getHubLongCopy('villas', lang)
    : null
