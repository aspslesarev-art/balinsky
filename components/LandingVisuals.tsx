...
const L = {
  ...
  de: {
    chatAsk: 'Was suchen Sie? Ich finde es.',
    listingTitle: 'Villa 2BR · Canggu',
    requestSent: 'Anfrage gesendet',
    managerJoin: 'Ein Manager kommt für eine Zoom-Präsentation dazu',
    yieldLabel: 'in der Nähe',
    thisOne: 'dieses',
    nearby: 'nebenan',
    walk: '6 Min',
    beach: 'Strand',
    verified: 'geprüft',
    devStat: '12 Projekte · 8 fertig',
    siteVideo: 'Baustellen-Video',
    you: 'Sie',
    market: 'Marktplatz',
    marketSub: 'Daten & Prüfungen',
    developer: 'Bauträger',
    perYear: 'pro Jahr',
    neighbours: 'über 8 Nachbarn',
    night: '/Nacht',
    sqmTitle: 'Preis pro m²',
    heat: 'Tourismuskarte',
    docsTitle: 'Objektdokumente',
    received: 'erteilt',
    lease: '25 Jahre',
    devName: 'Maison Bali',
    footageCaption: 'Vor Ort gefilmt',
  },
  zh: {
    chatAsk: '您在找什么？我来帮您匹配。',
    listingTitle: '别墅 2BR · Canggu',
    requestSent: '申请已发送',
    managerJoin: '经理将加入进行Zoom演示',
    yieldLabel: '周边',
    thisOne: '这套',
    nearby: '附近',
    walk: '6分钟',
  ...
  nl: {
    chatAsk: 'Wat zoekt u? Ik vind het.',
    listingTitle: 'Villa 2BR · Canggu',
    requestSent: 'Aanvraag verzonden',
    managerJoin: 'Een manager sluit aan voor een Zoom-presentatie',
    yieldLabel: 'nabij',
    thisOne: 'deze',
    nearby: 'nabij',
    walk: '6 min',
    ...
    devStat: '12 projecten · 8 opgeleverd',
    siteVideo: 'Locatievideo',
    you: 'U',
    market: 'Marktplaats',
    marketSub: 'data & controles',
    developer: 'Ontwikkelaar',
    perYear: 'per jaar',
    neighbours: 'over 8 buren',
    night: '/nacht',
    sqmTitle: 'Prijs per m²',
    heat: 'Toerismekaart',
    docsTitle: 'Objectdocumenten',
    received: 'afgegeven',
    lease: '25 jaar',
    devName: 'Maison Bali',
    footageCaption: 'Ter plaatse gefilmd',
  },
  ban: {
    chatAsk: 'Napi sane karereh? Tiang carikang.',
    listingTitle: 'Vila 2BR · Canggu',
    requestSent: 'Permintaan kakirim',
    managerJoin: 'Manajer jagi nyarengin anggen presentasi Zoom',
    yieldLabel: 'ring sisi',
    thisOne: 'sane puniki',
    nearby: 'nampek',
    walk: '6 mnt',
    beach: 'pasih',
    verified: 'kacek',
    devStat: '12 proyek · 8 puput',
    siteVideo: 'Video genah',
    you: 'Ragane',
    market: 'Marketplace',
    marketSub: 'data & pamariksan',
    developer: 'Pangwangun',
    perYear: 'nyabran warsa',
    neighbours: 'saking 8 pisaga',
    night: '/wengi',
    sqmTitle: 'Aji sabilang m²',
    heat: 'Peta pariwisata',
    docsTitle: 'Dokumen properti',
    received: 'kaicen',
    lease: '25 warsa',
    devName: 'Maison Bali',
    footageCaption: 'Karekam ring genah',
  },
  pl: {
    chatAsk: 'Czego szukasz? Dopasuję to.',
    listingTitle: 'Willa 2BR · Canggu',
    requestSent: 'Zgłoszenie wysłane',
    managerJoin: 'Menedżer dołączy do prezentacji na Zoomie',
    yieldLabel: 'w okolicy',
    thisOne: 'ta',
    nearby: 'w pobliżu',
    walk: '6 min',
    beach: 'plaża',
    verified: 'zweryfikowano',
    devStat: '12 projektów · 8 oddanych',
    siteVideo: 'Wideo z budowy',
    you: 'Ty',
    market: 'Marketplace',
    marketSub: 'dane i weryfikacja',
    developer: 'Deweloper',
    perYear: 'rocznie',
    neighbours: 'z 8 sąsiednich',
    night: '/noc',
    sqmTitle: 'Cena za m²',
    heat: 'Mapa turystyki',
    docsTitle: 'Dokumenty nieruchomości',
    received: 'wydane',
    lease: '25 lat',
    devName: 'Maison Bali',
    footageCaption: 'Nagrane na miejscu',
  },
  uk: {
    chatAsk: 'Що шукаєте? Підберу.',
    listingTitle: 'Віла 2BR · Canggu',
    requestSent: 'Заявку надіслано',
    managerJoin: 'Менеджер долучиться для Zoom-презентації',
    yieldLabel: 'по сусідах',
    thisOne: 'ця',
    nearby: 'поруч',
    walk: '6 хв',
    beach: 'пляж',
    verified: 'перевірено',
    devStat: '12 проєктів · 8 здано',
    siteVideo: 'Відео з будівництва',
    you: 'Ви',
    market: 'Маркетплейс',
    marketSub: 'дані та перевірка',
    developer: 'Забудовник',
    perYear: 'на рік',
    neighbours: 'по 8 сусідах',
    night: '/ніч',
    sqmTitle: 'Ціна за м²',
    heat: 'Карта туризму',
    docsTitle: 'Документи об’єкта',
    received: 'отримано',
    lease: '25 років',
    devName: 'Maison Bali',
    footageCaption: 'Знято на місці',
  },
} as const
