...
const COPY = {
  ...
  de: {
    coverEyebrow: 'Vergleichs-Auswahl',
    coverTitle: 'Ausgewählte Angebote',
    coverCount: (n: number) => `${n} ${n === 1 ? 'Angebot' : 'Angebote'}`,
    selectedAt: 'Erstellt',
    objectN: (i: number, total: number) => `Angebot ${i} / ${total}`,
    villa: 'Villa', apartment: 'Apartment', complex: 'Wohnanlage', rental: 'Miete',
    comparisonTitle: 'Vergleich',
    comparisonSubtitle: 'Vergleich der gespeicherten Angebote nebeneinander. Der beste Wert je Zeile ist grün hervorgehoben.',
    rowPrice: 'Preis',
    rowPriceM2: 'Preis / m²',
    rowPriceM2Year: 'Preis m² / Jahr',
    rowYield: 'Angegebene Rendite',
    rowBestRoi: 'ROI (unsere Schätzung)',
    rowLease: 'Leasehold',
    rowPermit: 'Genehmigung',
    rowDealType: 'Transaktion',
    rowStatus: 'Baustatus',
    rowCompletion: 'Fertigstellung',
    rowBedrooms: 'Schlafzimmer',
    rowArea: 'Fläche',
    rowLand: 'Grundstück',
    rowFloor: 'Etage',
    rowDistrict: 'Gebiet',
    rowLandUse: 'Landnutzung',
    rowStyle: 'Einrichtungsstil',
    ...
    factDistrict: 'Gebiet',
    factLease: 'Leasehold',
    factPermit: 'Genehmigung',
    factStatus: 'Status',
    factCompletion: 'Fertigstellung',
    factDealType: 'Transaktion',
    factYield: 'Rendite',
    factDeveloper: 'Bauträger',
    sqm: 'm²',
    years: 'J.',
    dealResale: 'Wiederverkauf', dealSecondary: 'Zweitmarkt', dealPrimary: 'Bauträger',
    devReady: (n: number) => `${n} fertiggestellt`,
    devInProgress: (n: number) => `${n} im Bau`,
    agentEyebrow: 'Ihr Agent',
    agentSubtitle: 'Direkt Kontakt aufnehmen — schnelle Antworten, Hilfe bei Besichtigungen',
    siteEyebrow: 'Auf der Website ansehen',
    siteTitle: 'Vollständige Auswahl',
    siteSubtitle: 'Jede Karte verlinkt auf die Angebotsseite mit aktuellem Preis und Kontaktformular',
    footerName: 'balinsky.info — Auswahl',
    footerNameAgent: 'Auswahl',
    factListingId: 'Such-ID',
    rowListingId: 'ID',
    landWarnTitle: 'Grundstück nicht für Tagesvermietung zugelassen',
    landWarnBody: (titles: string) => `Ihre Auswahl enthält ein Angebot auf einem Grundstück, das offiziell nicht für Tagesvermietung zugelassen ist: ${titles}. Prüfen Sie den legalen Vermietungsstatus beim Bauträger — er beeinflusst die Einnahmen aus Booking/Airbnb.`,
  },
  zh: {
    coverEyebrow: '比较清单',
    coverTitle: '精选房源',
    coverCount: (n: number) => `${n} 套房源`,
    selectedAt: '生成于',
    objectN: (i: number, total: number) => `房源 ${i} / ${total}`,
    villa: '别墅', apartment: '公寓', complex: '住宅区', rental: '租赁',
    comparisonTitle: '比较',
    comparisonSubtitle: '已保存房源的并排比较。每行最优值以绿色突出显示。',
    rowPrice: '价格',
    rowPriceM2: '单价 / m²',
    rowPriceM2Year: '单价 m² / 年',
    rowYield: '宣称收益率',
    ...
    devReady: (n: number) => `${n} 套已交付`,
    devInProgress: (n: number) => `${n} 套在建`,
    agentEyebrow: '您的经纪人',
    agentSubtitle: '直接联系——快速回复，协助看房',
    siteEyebrow: '在网站浏览',
    siteTitle: '完整清单',
    siteSubtitle: '每张卡片链接至房源页面，含最新价格和联系表单',
    footerName: 'balinsky.info — 清单',
    footerNameAgent: '清单',
    factListingId: '查询 ID',
    rowListingId: 'ID',
    landWarnTitle: '土地未划定用于日租',
    landWarnBody: (titles: string) => `您的清单中包含位于官方未划定用于日租的土地上的房源：${titles}。请向开发商核实合法出租状态——这会影响 Booking/Airbnb 的收入。`,
  },
  nl: {
    coverEyebrow: 'Vergelijkingslijst',
    coverTitle: 'Geselecteerde objecten',
    coverCount: (n: number) => `${n} ${n === 1 ? 'object' : 'objecten'}`,
    selectedAt: 'Gegenereerd',
    objectN: (i: number, total: number) => `Object ${i} / ${total}`,
    villa: 'Villa', apartment: 'Appartement', complex: 'Wooncomplex', rental: 'Huur',
    comparisonTitle: 'Vergelijking',
    comparisonSubtitle: 'Vergelijking van opgeslagen objecten naast elkaar. De beste waarde per rij is groen gemarkeerd.',
    rowPrice: 'Prijs',
    rowPriceM2: 'Prijs / m²',
    rowPriceM2Year: 'Prijs m² / jaar',
    rowYield: 'Geclaimd rendement',
    rowBestRoi: 'ROI (onze schatting)',
    rowLease: 'Leasehold',
    rowPermit: 'Vergunning',
    rowDealType: 'Transactie',
    rowStatus: 'Bouwstatus',
    rowCompletion: 'Oplevering',
    rowBedrooms: 'Slaapkamers',
    rowArea: 'Oppervlakte',
    rowLand: 'Grond',
    rowFloor: 'Verdieping',
    rowDistrict: 'Gebied',
    rowLandUse: 'Grondgebruik',
    rowStyle: 'Interieurstijl',
    rowDeveloper: 'Ontwikkelaar',
    factPrice: 'Prijs',
    factPriceM2: 'Prijs / m²',
    factBedrooms: 'Slaapkamers',
    factArea: 'Huis',
    factLand: 'Grond',
    factDistrict: 'Gebied',
    factLease: 'Leasehold',
    factPermit: 'Vergunning',
    factStatus: 'Status',
    factCompletion: 'Oplevering',
    factDealType: 'Transactie',
    factYield: 'Rendement',
    factDeveloper: 'Ontwikkelaar',
    sqm: 'm²',
    years: 'jr',
    dealResale: 'Doorverkoop', dealSecondary: 'Secundair', dealPrimary: 'Ontwikkelaar',
    devReady: (n: number) => `${n} opgeleverd`,
    devInProgress: (n: number) => `${n} in aanbouw`,
    agentEyebrow: 'Uw makelaar',
    agentSubtitle: 'Neem direct contact op — snelle antwoorden, hulp bij bezichtigingen',
    siteEyebrow: 'Bekijk op de site',
    siteTitle: 'Volledige lijst',
    siteSubtitle: 'Elke kaart linkt naar de objectpagina met actuele prijs en een contactformulier',
    footerName: 'balinsky.info — lijst',
    footerNameAgent: 'Lijst',
    factListingId: 'Zoek-ID',
    rowListingId: 'ID',
    landWarnTitle: 'Grond niet bestemd voor dagverhuur',
    landWarnBody: (titles: string) => `Uw lijst bevat een object op grond die officieel niet is bestemd voor dagverhuur: ${titles}. Verifieer de legale verhuurstatus bij de ontwikkelaar — dit beïnvloedt de inkomsten uit Booking/Airbnb.`,
  },
  ban: {
    coverEyebrow: 'Daftar perbandingan',
    coverTitle: 'Objek kapilih',
    coverCount: (n: number) => `${n} objek`,
    selectedAt: 'Kakaryanin',
    objectN: (i: number, total: number) => `Objek ${i} / ${total}`,
    villa: 'Vila', apartment: 'Apartemen', complex: 'Kompleks', rental: 'Sewa',
    comparisonTitle: 'Perbandingan',
    comparisonSubtitle: 'Perbandingan objek sane kasimpen masanding. Nilai pinih becik ring nyabran baris kacihnayang antuk warna gadang.',
    rowPrice: 'Aji',
    rowPriceM2: 'Aji / m²',
    rowPriceM2Year: 'Aji m² / warsa',
    rowYield: 'Asil kaklaim',
    rowBestRoi: 'ROI (petungan tiang)',
    rowLease: 'Leasehold',
    rowPermit: 'Ijin',
    rowDealType: 'Jenis transaksi',
    rowStatus: 'Status wangunan',
    rowCompletion: 'Serah terima',
    rowBedrooms: 'Kamar',
    rowArea: 'Luas',
    rowLand: 'Tanah',
    rowFloor: 'Lantai',
    rowDistrict: 'Wewengkon',
    rowLandUse: 'Peruntukan tanah',
    rowStyle: 'Gaya interior',
    ...
    factDealType: 'Jenis transaksi',
    factYield: 'Asil',
    factDeveloper: 'Pangwangun',
    sqm: 'm²',
    years: 'thn',
    dealResale: 'Adol malih', dealSecondary: 'Sekunder', dealPrimary: 'Saking pangwangun',
    devReady: (n: number) => `${n} sampun puput`,
    devInProgress: (n: number) => `${n} kantun kawangun`,
    agentEyebrow: 'Agen Ragane',
    agentSubtitle: 'Ngwacana langsung — pasaur gelis, nulungin ninjau',
    siteEyebrow: 'Telusurin ring situs',
    siteTitle: 'Daftar jangkep',
    siteSubtitle: 'Nyabran kartu mataut ka kaca objek madaging aji anyar lan formulir kontak',
    footerName: 'balinsky.info — daftar',
    footerNameAgent: 'Daftar',
    factListingId: 'ID ngrereh',
    rowListingId: 'ID',
    landWarnTitle: 'Tanah nenten kaperuntukang antuk sewa harian',
    landWarnBody: (titles: string) => `Daftar Ragane madaging objek ring tanah sane secara resmi nenten kaperuntukang antuk sewa harian: ${titles}. Pastiang status sewa legal ring pangwangun — puniki mangaruhin pikolih saking Booking/Airbnb.`,
  },
  pl: {
    coverEyebrow: 'Lista porównawcza',
    coverTitle: 'Wybrane oferty',
    coverCount: (n: number) => `${n} ${n === 1 ? 'oferta' : 'ofert'}`,
    selectedAt: 'Wygenerowano',
    objectN: (i: number, total: number) => `Oferta ${i} / ${total}`,
    villa: 'Willa', apartment: 'Apartament', complex: 'Kompleks', rental: 'Wynajem',
    comparisonTitle: 'Porównanie',
    comparisonSubtitle: 'Porównanie zapisanych ofert obok siebie. Najlepsza wartość w każdym wierszu jest podświetlona na zielono.',
    rowPrice: 'Cena',
    rowPriceM2: 'Cena / m²',
    rowPriceM2Year: 'Cena m² / rok',
    rowYield: 'Deklarowana rentowność',
    rowBestRoi: 'ROI (nasze szacunki)',
    rowLease: 'Leasehold',
    rowPermit: 'Pozwolenie',
    rowDealType: 'Transakcja',
    rowStatus: 'Status budowy',
    rowCompletion: 'Oddanie',
    rowBedrooms: 'Sypialnie',
    rowArea: 'Powierzchnia',
    rowLand: 'Działka',
    rowFloor: 'Piętro',
    rowDistrict: 'Dzielnica',
    rowLandUse: 'Przeznaczenie działki',
    rowStyle: 'Styl wnętrza',
    rowDeveloper: 'Deweloper',
    factPrice: 'Cena',
    factPriceM2: 'Cena / m²',
    factBedrooms: 'Sypialnie',
    factArea: 'Dom',
    factLand: 'Działka',
    factDistrict: 'Dzielnica',
    factLease: 'Leasehold',
    factPermit: 'Pozwolenie',
    factStatus: 'Status',
    factCompletion: 'Oddanie',
    factDealType: 'Transakcja',
    factYield: 'Rentowność',
    factDeveloper: 'Deweloper',
    sqm: 'm²',
    years: 'lat',
    dealResale: 'Odsprzedaż', dealSecondary: 'Rynek wtórny', dealPrimary: 'Od dewelopera',
    devReady: (n: number) => `${n} oddanych`,
    devInProgress: (n: number) => `${n} w budowie`,
    agentEyebrow: 'Twój agent',
    agentSubtitle: 'Skontaktuj się bezpośrednio — szybka odpowiedź, pomoc przy oglądaniu',
    siteEyebrow: 'Przeglądaj na stronie',
    siteTitle: 'Pełna lista',
    siteSubtitle: 'Każda karta prowadzi do strony oferty z aktualną ceną i formularzem kontaktowym',
    footerName: 'balinsky.info — lista',
    footerNameAgent: 'Lista',
    factListingId: 'ID wyszukiwania',
    rowListingId: 'ID',
    landWarnTitle: 'Działka nieprzeznaczona pod wynajem dobowy',
    landWarnBody: (titles: string) => `Twoja lista zawiera ofertę na działce oficjalnie nieprzeznaczonej pod wynajem dobowy: ${titles}. Zweryfikuj legalny status wynajmu u dewelopera — wpływa on na przychody z Booking/Airbnb.`,
  },
  uk: {
    coverEyebrow: 'Список для порівняння',
    coverTitle: 'Вибрані обʼєкти',
    coverCount: (n: number) => `${n} ${n === 1 ? 'обʼєкт' : 'обʼєктів'}`,
    selectedAt: 'Сформовано',
    objectN: (i: number, total: number) => `Обʼєкт ${i} / ${total}`,
    villa: 'Вілла', apartment: 'Апартаменти', complex: 'Комплекс', rental: 'Оренда',
    comparisonTitle: 'Порівняння',
    comparisonSubtitle: 'Порівняння збережених обʼєктів поруч. Найкраще значення в кожному рядку виділено зеленим.',
    rowPrice: 'Ціна',
    rowPriceM2: 'Ціна / м²',
    rowPriceM2Year: 'Ціна м² / рік',
    rowYield: 'Заявлена дохідність',
    rowBestRoi: 'ROI (наша оцінка)',
    rowLease: 'Лізхолд',
    rowPermit: 'Дозвіл',
    rowDealType: 'Тип угоди',
    rowStatus: 'Статус будівництва',
    rowCompletion: 'Здача',
    rowBedrooms: 'Спальні',
    rowArea: 'Площа',
    rowLand: 'Земля',
    rowFloor: 'Поверх',
    rowDistrict: 'Район',
    rowLandUse: 'Призначення землі',
    rowStyle: 'Стиль інтерʼєру',
    rowDeveloper: 'Забудовник',
    factPrice: 'Ціна',
    factPriceM2: 'Ціна / м²',
    factBedrooms: 'Спальні',
    factArea: 'Будинок',
    factLand: 'Земля',
    factDistrict: 'Район',
    factLease: 'Лізхолд',
    ...
    factDealType: 'Тип угоди',
    factYield: 'Дохідність',
    factDeveloper: 'Забудовник',
    sqm: 'м²',
    years: 'р.',
    dealResale: 'Перепродаж', dealSecondary: 'Вторинний ринок', dealPrimary: 'Від забудовника',
    devReady: (n: number) => `${n} здано`,
    devInProgress: (n: number) => `${n} будується`,
    agentEyebrow: 'Ваш агент',
    agentSubtitle: 'Звʼяжіться напряму — швидко відповім і допоможу з переглядом',
    siteEyebrow: 'Докладніше на сайті',
    siteTitle: 'Повна добірка',
    siteSubtitle: 'Кожна картка веде на сторінку обʼєкта з актуальною ціною та формою звʼязку',
    footerName: 'balinsky.info — добірка',
    footerNameAgent: 'Добірка',
    factListingId: 'ID для пошуку',
    rowListingId: 'ID',
    landWarnTitle: 'Земля не для подобової оренди',
    landWarnBody: (titles: string) => `У добірці є обʼєкт на землі, офіційно не призначеній для подобової оренди: ${titles}. Уточніть легальний статус здачі у забудовника — це впливає на дохідність від Booking/Airbnb.`,
  },
} as const
